 ...
 *
 */
final public class ReserveCommitMessage {

    /**
     *
     */
    final private static String SOAP_ACTION = "http://schemas.ogf.org/nsi/2013/12/connection/service/reserveCommit";
    ...
    private static SOAPMessage createBody (SOAPMessage soapMessage, String connectionId) throws SOAPException {
        ...
        SOAPElement reserveCommit = soapBody.addChildElement("reserveCommit", "type");
