 ...
 *
 */
final public class QueryResultSyncMessage {

    /**
     *
     */
    final private static String SOAP_ACTION = "http://schemas.ogf.org/nsi/2013/12/connection/service/queryResultSync";
    ...
    public static SOAPMessage createMessage (String connectionId, String providerNSA, String requesterNSA, String replyTo) throws SOAPException {
        ...
        if (replyTo == null || replyTo.equals("")) {
            throw new SOAPException("ReplyTo is mandatory for QueryResultSyncMessage.");
        }
    ...
    private static SOAPMessage createBody (SOAPMessage soapMessage, String connectionId) throws SOAPException {
        ...
        SOAPElement reserveCommit = soapBody.addChildElement("queryResultSync", "type");
