 ...
 *
 */
final public class ProvisionMessage {

    /**
     *
     */
    final private static String SOAP_ACTION = "http://schemas.ogf.org/nsi/2013/12/connection/service/provision";
    ...
    private static SOAPMessage createBody (SOAPMessage soapMessage, String connectionId) throws SOAPException {
        ...
        SOAPElement reserveCommit = soapBody.addChildElement("provision", "type");
