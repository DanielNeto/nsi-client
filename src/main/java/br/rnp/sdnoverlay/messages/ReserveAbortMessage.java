 ...
 *
 */
final public class ReserveAbortMessage {

    /**
     *
     */
    final private static String SOAP_ACTION = "http://schemas.ogf.org/nsi/2013/12/connection/service/reserveAbort";
    ...
    private static SOAPMessage createBody (SOAPMessage soapMessage, String connectionId) throws SOAPException {
        ...
        SOAPElement reserveCommit = soapBody.addChildElement("reserveAbort", "type");
